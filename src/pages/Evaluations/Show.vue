  ...
  <div class="max-w-6xl mx-auto space-y-6">
    ...
    <div v-else-if="evaluation" class="space-y-6">
      ...
      <PageHeader
        ...
        :description="userEvaluation?.finished_at ? 'Tinjauan hasil pengerjaan evaluasi Anda.' : `Durasi: ${evaluation.duration} menit • ${evaluation.questions?.length || 0} Soal`"
        :show-back="true"
      ...
      <!-- ================================================================= -->
      <!-- 1. ACTIVE EVALUATION TAKING MODE -->
      <!-- ================================================================= -->
        ...
        <div class="grid gap-6 md:grid-cols-3 lg:grid-cols-4 items-start">
          ...
          <div class="hidden md:block md:sticky md:top-20 space-y-4">
            ...
            <div class="bg-card rounded-2xl shadow-xs border border-border p-5 text-center space-y-3">
              ...
              <p class="text-xs text-muted-foreground">Evaluasi otomatis tersimpan jika waktu habis.</p>
            </div>
      ...
      <!-- ================================================================= -->
      <!-- 2. COMPLETED EVALUATION REVIEW MODE -->
      <!-- ================================================================= -->
      <div v-if="userEvaluation && userEvaluation.finished_at" class="space-y-6">
        ...
        <!-- Back to Evaluations Navigation Button -->
...
async function loadData() {
  ...
  try {
    ...
    // A blocked evaluation comes back without an attempt to render
    if (!data.success) {
    ...
    showBlocked('Terjadi kesalahan saat memuat evaluasi.');
  } finally {
...
async function handleBackNavigation() {
  if (userEvaluation.value && !userEvaluation.value.finished_at) {
    const res = await swConfirm({
      ...
      text: 'Waktu evaluasi akan terus berjalan jika Anda keluar. Yakin ingin kembali ke daftar evaluasi?',
