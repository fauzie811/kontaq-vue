  ...
  <div class="grid gap-5 md:grid-cols-3 lg:grid-cols-4">
    <div class="md:col-span-2 lg:col-span-3">
      <div v-if="quiz" class="mt-4 space-y-5">
        ...
        <div v-if="userQuiz.finished_at" class="overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-6">
          <div class="bg-emerald-50 rounded-2xl p-5 border border-emerald-200 text-center">
            ...
            <p class="text-base text-emerald-800">Nilai Anda: <strong class="text-2xl font-bold text-emerald-950">{{ userQuiz.score }}</strong></p>
          </div>
          ...
          >
            ...
            <div v-else class="py-1">
              <div
                ...
                :key="option"
                :class="[
                  userQuiz.answers[question.id] === option ? 'bg-[#bbf7d0] text-emerald-950 font-medium' : 'text-gray-800',
    ...
    <div>
      <div v-if="quiz && !userQuiz.finished_at" class="space-y-5 md:sticky md:top-20">
