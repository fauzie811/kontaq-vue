<template>
  <div class="space-y-5">
    <div v-for="question in questions" :key="question.id" class="overflow-hidden bg-white rounded-lg shadow">
            ...
            <RadioGroupOption :key="question.id + '_a'" value="a" v-slot="{ checked, active }">
              <div
                ...
                <RadioGroupLabel as="span" :class="[checked ? 'text-indigo-900' : 'text-gray-900', 'ml-3']">
                  a.</RadioGroupLabel>
                <RadioGroupLabel as="span" :class="[checked ? 'text-indigo-900' : 'text-gray-900', 'ml-3']">
                  {{ question.option_a }}</RadioGroupLabel>
              </div>
            </RadioGroupOption>
            <RadioGroupOption :key="question.id + '_b'" value="b" v-slot="{ checked, active }">
              <div
                ...
                <RadioGroupLabel as="span" :class="[checked ? 'text-indigo-900' : 'text-gray-900', 'ml-3']">
                  b.</RadioGroupLabel>
                <RadioGroupLabel as="span" :class="[checked ? 'text-indigo-900' : 'text-gray-900', 'ml-3']">
                  {{ question.option_b }}</RadioGroupLabel>
              </div>
            </RadioGroupOption>
            <RadioGroupOption :key="question.id + '_c'" value="c" v-slot="{ checked, active }">
              <div
                ...
                <RadioGroupLabel as="span" :class="[checked ? 'text-indigo-900' : 'text-gray-900', 'ml-3']">
                  c.</RadioGroupLabel>
                <RadioGroupLabel as="span" :class="[checked ? 'text-indigo-900' : 'text-gray-900', 'ml-3']">
                  {{ question.option_c }}</RadioGroupLabel>
              </div>
            </RadioGroupOption>
            <RadioGroupOption :key="question.id + '_d'" value="d" v-slot="{ checked, active }">
              <div
                ...
                <RadioGroupLabel as="span" :class="[checked ? 'text-indigo-900' : 'text-gray-900', 'ml-3']">
                  d.</RadioGroupLabel>
                <RadioGroupLabel as="span" :class="[checked ? 'text-indigo-900' : 'text-gray-900', 'ml-3']">
                  {{ question.option_d }}</RadioGroupLabel>
              </div>
            </RadioGroupOption>
          </div>
        </RadioGroup>
