...
export const swAlert = ({
    ...
    Swal.fire({
        ...
        customClass: {
            ...
            icon:
                'm-0! mx-auto! flex! h-12! w-12! shrink-0! items-center! justify-center! rounded-full! border-0! sm:h-10! sm:w-10! mt-5! sm!mt-6 sm:ml-6! col-start-1! col-end-3! sm:col-end-2! ' +
                iconColor(icon),
